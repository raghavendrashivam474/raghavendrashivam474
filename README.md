...
| -------------------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------- |
| **Healthcare Access**<br>Emergency data not instantly accessible | **🏥 Hospital PHR**<br>QR-based system for instant record access | React Native, Node.js, MongoDB, Firebase/Supabase    |
